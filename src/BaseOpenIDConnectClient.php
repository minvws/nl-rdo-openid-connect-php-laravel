 ...
 * ** WARNING **
 * This class is currently copied from this PR https://github.com/jumbojett/OpenID-Connect-PHP/pull/376 because we need the changes now.
 * It is intended to remove this class when the PR is merged.
 */
